var addProjectElements, createProjectElement, initBPCL, initIsotope, resizeIsotope, updateIsotopeLayout, _data;
...
updateIsotopeLayout = function(target, layoutMode, callback) {
  $(target).isotope({
    layoutMode: layoutMode
  });
  return $(document).oneTime(1000, function() {
    if (!window.contentScroll) {
      initScrolls();
    }
